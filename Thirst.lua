...
local THIRST_RATE_WALKING = 0.0144 * 2
local THIRST_RATE_RUNNING = 0.0216 * 2
local THIRST_RATE_MOUNTED = 0.0108 * 2
local THIRST_RATE_COMBAT = 0.045 * 2
local SWIMMING_RECOVERY_RATE = 0.012
local DRINKING_RECOVERY_RATE = 0.4 * 6 -- Increased, no need to consume so many items
local RESTED_DRINKING_RECOVERY = 0.6 * 6 -- Increased, no need to consume so many items
local RAIN_RECOVERY_RATE = 0.024

local CHECKPOINT_WORLD = 0 -- Better breakpoints to exclude trainer
local CHECKPOINT_FIRE = 0 -- Better breakpoints to exclude trainer
local CHECKPOINT_RESTED = 0 -- Better breakpoints to exclude trainer
