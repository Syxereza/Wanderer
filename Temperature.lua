...
local updateTimer = 0
local UPDATE_INTERVAL = 1.0 / 5 -- Faster update to seem more smooth-ish
...
local ZONE_BASE_TEMPS = { -- Added all zones from TBC to TWW
    -- Eastern Kingdoms
    ["zulaman"] = 14,
    ["voidstorm"] = -4,
    ["haranar"] = 33,
    ...
    ["stormwind"] = 22,
    ["ironforge"] = -5,
        --["thegreatforge"] = 30, -- Central Ironforge
    ["undercity"] = 10,
    ["silvermooncity"] = 32,

    -- Eastern Kingdoms Seas
    ["thegreatsea"] = 15,
    ["theforbiddingsea"] = 15,
    ["theveiledsea"] = 15,
    ...
    -- Outland
    ["hellfirepeninsula"] = 60,
    ["shadowmoonvalley:outland"] = 30,
    ["bladesedgemountains"] = 35,
    ["netherstorm"] = 20,
    ["nagrand"] = 25,
    ["zangarmarsh"] = 15,
    ["terokkarforest"] = 25,

    -- Outland Starting Zones WIP
    -- ["azuremyst"] = 45,
    -- ["bloodmyst"] = 45,
    -- ["eversong"] = 45,
    -- ["ghostlands"] = 45,
    ...
    ["thejadeforest"] = 21,
    ["jadeforest"] = 21,
    ["valleyofthefourwinds"] = 22,
    ["krasarangwilds"] = 19,
    ["valeofeternalblossoms"] = 24,
    ["kunlaisummit"] = 18,
    ["dreadwastes"] = 19,
    ["townlongsteppes"] = 20,
    ["isleofgiants"] = 17,
    ...
    -- Pandaria Capitals
    --["Shrines"] = 22, -- No need, vale and indoors already works
    ...
    -- Shadowlands Capitals
    ["oribos"] = 17,

    -- Shadowlands Seas WIP
    --["thenorthsea"] = 10,
    ...
    ["ohnahranplains"] = 20,
    ["thaldraszus"] = 22,
    ["theforbiddenreach"] = 18,
    ["theazurespan"] = -6,
    ["zaralekcavern"] = 10,
    ["emeralddream"] = 22,
    
    -- Dragon Isles Capitals
    ["valdrakken"] = 18,
    
    -- Dragon Isles Seas WIP
    --["thenorthsea"] = 10,
...
local DAY_WARM_RATE = 1.5 * 20 -- Increased/faster to more quickly change temperature
local DAY_COOL_RATE = 0.6 * 20 -- Increased/faster to more quickly change temperature
local NIGHT_COOL_RATE = 1.5 * 20 -- Increased/faster to more quickly change temperature
local NIGHT_WARM_RATE = 0.6 * 20 -- Increased/faster to more quickly change temperature
...
local FIRE_OUTDOOR_RECOVERY = 0.05+0.5
local FIRE_INDOOR_RECOVERY = 0.2+0.5
